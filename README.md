...
```
pod 'FirebaseCore', :git => 'https://github.com/toandk/firebase-ios-sdk.git', :branch => 'master'
pod 'FirebaseFirestore', :git => 'https://github.com/toandk/firebase-ios-sdk.git', :branch => 'master'
```
